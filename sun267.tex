...
{Copyright \copyright\ 2012 Science and Technology Facilities
  Council. Copyright \copyright\ 2014-2015 Cornell University.}

% Variable part - replace [xxx] as appropriate.
\newcommand{\stardocnumber}    {267.3}
\newcommand{\stardocauthors}   {Tim Jenness}
\newcommand{\stardocdate}      {2015 January 1}
\newcommand{\stardoctitle}     {PAL --- Positional Astronomy Library}
\newcommand{\stardocversion}   {0.9.0}
